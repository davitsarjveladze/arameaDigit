...
<body style="min-height: 100%">
    ...
    <div id="app" v-cloak style="min-height: 100%">
...
{{--                    <a href="Les-Permanences" class="banner-tool"><img src="plugins/aremae/img/contact.svg" width="34" height="34" alt="Contact"></a>--}}
        ...
        <div id="carouselExampleIndicators" class="carousel slide " data-ride="carousel">
            <ol class="carousel-indicators">
                <li data-target="#carouselExampleIndicators" style="opacity: 0!important;" data-slide-to="0" class="active"></li>
                <li data-target="#carouselExampleIndicators" style="opacity: 0!important;" data-slide-to="1"></li>
                <li data-target="#carouselExampleIndicators" style="opacity: 0!important;" data-slide-to="2"></li>
            </ol>
            <div class="carousel-inner ">
                <div class="carousel-item active" style="margin-top: 0px">
                    <div class="slide ">
                        <div class="slide-img row">
                            <div style="background-image:url('https://via.placeholder.com/350x430')" class="col-6"></div>
                            <div style="background-image:url('https://via.placeholder.com/350x430')" class="col-6"></div>
                        </div>
                        <div class="slide-texte">
                            <div class="slide-texte-inner">
                                    <span href="Devenir-adherent" class="slide-titre-link">
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. A at consequatur consequuntur debitis dolor dolore est ex facilis harum illum ipsam ipsum necessitatibus nostrum perferendis saepe sapiente tempore vel, voluptas.
                                    </span>
                            </div>
                        </div>
                    </div>
